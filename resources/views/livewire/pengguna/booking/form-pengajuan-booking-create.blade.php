...
<div>
    ...
    <button type="button" class="btn btn-primary" wire:click="$dispatchSelf('openModal')">
        Buat Pengajuan
    </button>
                ...
                <form wire:submit.prevent="simpanPengajuanBooking">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <button type="button" class="btn-close" wire:click="$dispatchSelf('closeModal')" aria-label="Close"></button>
                        </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" wire:click="$dispatchSelf('closeModal')">Tutup</button>
